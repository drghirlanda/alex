...
MaxITI & 3000
\\\noalign{\medskip}
Response & \textless{}space\textgreater{}
\\\noalign{\medskip}
MaxResponses & 100
\\\noalign{\medskip}
...
\hline
\noalign{\medskip}
\caption{Sample \texttt{Parameters.csv} file with default values.}
\end{longtable}
...
\texttt{:} special notations for stimuli. \label{stimuli-special}}
\end{longtable}
...
\\\noalign{\medskip}
\hline\noalign{\medskip}
1 & Red & 20 & 1 & Smiley & \textless{}left\textgreater{}
\\\noalign{\medskip}
1 & White & 20 & 1 & Smiley & \textless{}right\textgreater{}
\\\noalign{\medskip}
\hline
\noalign{\medskip}
\caption{A \texttt{Phases.csv} specifying different responses for
stimuli Red and White. \label{per-stimulus-responses}}
\end{longtable}
...
\\\noalign{\medskip}
\hline\noalign{\medskip}
1 & Red & 20 & .9 & Smiley & *\textless{}space\textgreater{}
\\\noalign{\medskip}
\hline
\noalign{\medskip}
...
subject behavior. \label{classical}}
\end{longtable}
...
\ref{stimuli-instructions}). \label{phases-instructions}}
\end{longtable}
...
instructions and a final message (see also Table
\ref{phases-instructions}). \label{stimuli-instructions}}
\end{longtable}
